package valoeghese.salt.ui.menu.operation;
...
public class NodeVoltageAnalysis extends JMenuItem {
	public NodeVoltageAnalysis(String name) {
		super(name);
		...
		this.addActionListener(e -> {
			...
			BiMap<Integer, Node> nodes = NodeVoltageAnalysis.this.createNodeIdMap(heads);
			SystemOfEquations system = NodeVoltageAnalysis.this.computeSystemOfEquations(nodes, superNodes);
